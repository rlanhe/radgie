...
using System.Xml;
using System.IO;
using tOutput = Microsoft.Xna.Framework.Graphics.DepthStencilState;

namespace Radgie.File
{
    /// <summary>
    /// Objeto especializado en la lectura de ficheros .dss
    /// </summary>
    public class DepthStencilStateFileReader : ContentTypeReader<tOutput>
    {
        #region Methods
