...
using System.Xml;
using System.IO;
using tOutput = Microsoft.Xna.Framework.Graphics.BlendState;

namespace Radgie.File
{
    /// <summary>
    /// Objeto especializado en la lectura de ficheros .bs
    /// </summary>
    public class BlendStateFileReader : ContentTypeReader<tOutput>
    {
        #region Methods
