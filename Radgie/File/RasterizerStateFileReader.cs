...
using System.Xml;
using System.IO;
using tOutput = Microsoft.Xna.Framework.Graphics.RasterizerState;

namespace Radgie.File
{
    /// <summary>
    /// Objeto para la lectura de ficheros .rs.
    /// </summary>
    public class RasterizerStateFileReader : ContentTypeReader<tOutput>
    {
        #region Methods
