...
{
    /// <summary>
    /// Adapta un control analogico a un control analogico con valores acotados e inverso
    /// </summary>
    public class Analogical2AnalogicalInverterAdapter: IAnalogicalControl
    {
        #region Properties
        ...
        public float Value
        {
            get
            {
                return GetValue(mAControl.Value)*-1.0f;
            }
        }
        ...
        public Analogical2AnalogicalInverterAdapter(IAnalogicalControl aControl, float min, float max): this(aControl, min, max, max)
        {
        }
        ...
        /// <exception cref="ArgumentNullException">Si aControl es null</exception>
        /// <exception cref="ArgumentOutOfRangeException">Si min > max</exception>
        public Analogical2AnalogicalInverterAdapter(IAnalogicalControl aControl, float min, float max, float gain)
        {
            if (aControl == null)
            {
